...
#define GATT_PERM_READ_SC_ENC_MITM  (1 << 9) /* bit 9 */
#endif
...
#if (defined BTM_LE_SECURE_CONN && BTM_LE_SECURE_CONN == TRUE)
#define GATT_PERM_WRITE_SC_ENC_MITM  (1 << 10) /* bit 9 */
#endif
...
#if (defined BTM_LE_SECURE_CONN && BTM_LE_SECURE_CONN == TRUE)
#define GATT_READ_ALLOWED           (GATT_PERM_READ | GATT_PERM_READ_ENCRYPTED | GATT_PERM_READ_ENC_MITM | GATT_PERM_READ_SC_ENC_MITM)
#else
...
#if (defined BTM_LE_SECURE_CONN && BTM_LE_SECURE_CONN == TRUE)
#define GATT_READ_ENCRYPTED_REQUIRED   (GATT_PERM_READ_ENCRYPTED | GATT_PERM_READ_ENC_MITM | GATT_PERM_READ_SC_ENC_MITM)
#else
...
#define GATT_WRITE_ALLOWED          (GATT_PERM_WRITE | GATT_PERM_WRITE_ENCRYPTED | GATT_PERM_WRITE_ENC_MITM | \
                                     GATT_PERM_WRITE_SIGNED | GATT_PERM_WRITE_SIGNED_MITM | GATT_PERM_WRITE_SC_ENC_MITM)
#else
#define GATT_WRITE_ALLOWED          (GATT_PERM_WRITE | GATT_PERM_WRITE_ENCRYPTED | GATT_PERM_WRITE_ENC_MITM | \
...
#if (defined BTM_LE_SECURE_CONN && BTM_LE_SECURE_CONN == TRUE)
#define GATT_WRITE_ENCRYPTED_PERM   (GATT_PERM_WRITE_ENCRYPTED | GATT_PERM_WRITE_ENC_MITM | GATT_PERM_WRITE_SC_ENC_MITM)
#else
...
#if (defined BTM_LE_SECURE_CONN && BTM_LE_SECURE_CONN == TRUE)
#define GATT_AUTH_REQ_SEC_MITM          5
#define GATT_AUTH_REQ_SEC_NO_MITM       6
#endif
