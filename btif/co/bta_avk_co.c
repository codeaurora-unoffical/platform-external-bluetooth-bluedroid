 ...
 **
 *******************************************************************************/
BTA_API void bta_avk_co_audio_disc_res(tBTA_AV_HNDL hndl, UINT8 num_seps, UINT8 num_snk,
 ...
 **
 *******************************************************************************/
BTA_API UINT8 bta_avk_co_audio_getconfig(tBTA_AV_HNDL hndl, tBTA_AV_CODEC codec_type,
 ...
 **
 *******************************************************************************/
BTA_API void bta_avk_co_audio_setconfig(tBTA_AV_HNDL hndl, tBTA_AV_CODEC codec_type,
 ...
 **
 *******************************************************************************/
BTA_API void bta_avk_co_audio_open(tBTA_AV_HNDL hndl, tBTA_AV_CODEC codec_type, UINT8 *p_codec_info,
        UINT16 mtu)
{
    tBTA_AVK_CO_PEER *p_peer;
    UNUSED(p_codec_info);
 ...
 **
 *******************************************************************************/
BTA_API void bta_avk_co_audio_close(tBTA_AV_HNDL hndl, tBTA_AV_CODEC codec_type, UINT16 mtu)
 ...
 **
 *******************************************************************************/
BTA_API void bta_avk_co_audio_start(tBTA_AV_HNDL hndl, tBTA_AV_CODEC codec_type,
 ...
 **
 *******************************************************************************/
BTA_API extern void bta_avk_co_audio_stop(tBTA_AV_HNDL hndl, tBTA_AV_CODEC codec_type)
{
    UNUSED(hndl);
    UNUSED(codec_type);
 ...
 **
 *******************************************************************************/
BTA_API void * bta_avk_co_audio_sink_data_path(tBTA_AV_CODEC codec_type, UINT32 *p_len,
        UINT32 *p_timestamp)
{
 ...
 **
 *******************************************************************************/
BTA_API void bta_avk_co_audio_delay(tBTA_AV_HNDL hndl, UINT16 delay)
{
    FUNC_TRACE();
