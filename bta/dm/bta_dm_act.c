...
void bta_dm_set_dev_name (tBTA_DM_MSG *p_data)
{
    ...
    BTM_TRACE_DEBUG2("%s: name: %s ", __FUNCTION__, (char*)p_data->set_name.name);
...
static UINT8 bta_dm_sp_cback (tBTM_SP_EVT event, tBTM_SP_EVT_DATA *p_data)
{
    ...
    case BTM_SP_KEY_NOTIF_EVT:
        ...
        BCM_STRNCPY_S((char*)sec_event.key_notif.bd_name, sizeof(BD_NAME), (char*)p_data->key_notif.bd_name, (BD_NAME_LEN));
